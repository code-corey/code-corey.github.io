...
> 上一篇：[《裸写 Function Calling 循环：Agent 的原子操作》](/Ai/roadmap/1-model-api/model-api-03-function-calling)
> 下一篇：[《上下文耗尽与压缩：长对话的续命术》](/Ai/roadmap/1-model-api/model-api-05-context-compression)
