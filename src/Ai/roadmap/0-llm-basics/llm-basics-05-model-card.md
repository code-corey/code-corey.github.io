...
> 上一篇：[《本地跑通一个模型：参数量、量化与体验》](/Ai/roadmap/0-llm-basics/llm-basics-04-local-model)
> 下一篇：[《Prompt 三件套：system、few-shot 与 CoT》](/Ai/roadmap/1-model-api/model-api-01-prompt-trio)
