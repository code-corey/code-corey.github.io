...
> 上一篇：[《训练三段论：pretrain、SFT 与 RL 各产出什么》](/Ai/roadmap/0-llm-basics/llm-basics-03-training-paradigms)
> 下一篇：[《模型卡阅读法：7B、MoE 与选型档位》](/Ai/roadmap/0-llm-basics/llm-basics-05-model-card)
