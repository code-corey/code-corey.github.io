...
> 上一篇：[《下一个 token 的概率世界：模型到底在算什么》](/Ai/roadmap/0-llm-basics/llm-basics-01-next-token)（已完结）
> 下一篇：[《训练三段论：pretrain、SFT 与 RL 各产出什么》](/Ai/roadmap/0-llm-basics/llm-basics-03-training-paradigms)
