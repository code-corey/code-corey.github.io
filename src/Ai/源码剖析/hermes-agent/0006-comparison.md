...
> 对照对象：[NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)（v0.21.0，本系列已剖）· [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness)（v0.1.2-alpha.2，[本站专栏已剖](/Ai/源码剖析/deepseek-harness/)）
...
> 相关系列：[DeepSeek Harness 源码：一切皆插件](/Ai/源码剖析/deepseek-harness/)（9 篇已完结） · 回到 [专栏首页](/Ai/源码剖析/hermes-agent/)
