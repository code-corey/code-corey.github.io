---
title: "VoiceMem: Infrastructure for the next generation of voice agents（VoiceMem：下一代语音智能体的通用记忆基础设施）"
shortTitle: "VoiceMem 语音记忆层"
...
tag:
  - "值得研究的仓库"
description: "为语音智能体提供通用记忆的开源基础设施：左右脑分置信息与情绪存储，全流式架构从底层消除延迟。GitHub 1126 星。"
---
