---
title: "gap-trap: Turn vibe coding into high quality code（gap-trap：给 Vibe Coding 装上质量门禁）"
shortTitle: "gap-trap 质量门禁"
...
tag:
  - "值得研究的仓库"
description: "读你的代码库、生成贴合本库的规则、再为每条规则装一个会挂 CI 的「门禁」：让 AI 写的代码不靠人肉逐行审查也保持正确。JS 实现，7 天 146 星。"
---
