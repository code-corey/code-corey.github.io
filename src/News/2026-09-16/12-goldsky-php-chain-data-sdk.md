---
title: "goldsky-php: A production-ready PHP/Laravel SDK for Goldsky（goldsky-php：链上数据基础设施的 PHP SDK）"
shortTitle: "goldsky-php 链上SDK"
...
tag:
  - "Web3 & Crypto"
description: "社区维护的 PHP 8.1+/Laravel SDK，全量封装 Goldsky REST v1.2.0 的 40 个操作外加 Subgraph GraphQL 与 Edge JSON-RPC，含 webhook 验签、重试与分页——存量 PHP 系统接链上数据的稀缺桥梁。⭐17（7天）。"
---
