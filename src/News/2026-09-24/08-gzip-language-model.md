---
title: "Can gzip be a language model?（gzip 能当语言模型吗？）"
shortTitle: "gzip 当语言模型"
...
tag:
  - "前沿论文"
description: "gzip 真的能当语言模型吗？一篇 397 分热帖从「压缩即预测」的第一性原理出发，探讨超低资源语言建模的边界与工程启示，是理解 LM 本质的绝佳教学样本。"
---
