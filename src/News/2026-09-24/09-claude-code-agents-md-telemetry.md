---
title: "Claude Code reads AGENTS.md only when telemetry is on [fixed]（Claude Code 仅在遥测开启时读取 AGENTS.md，已修复）"
shortTitle: "Claude Code 遥测争议"
...
tag:
  - "安全 & 评测"
description: "安全研究者发现 Claude Code 仅在遥测开启时才读取 AGENTS.md（已修复），AI 编程工具的遥测边界与供应链信任再敲警钟，HN 442 分 250 评论。"
---
