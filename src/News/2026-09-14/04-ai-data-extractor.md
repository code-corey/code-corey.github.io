---
title: "AI Coding Assistant Data Extraction（AI 编程助手聊天记录统一提取）"
shortTitle: "AI 会话记录提取器"
...
tag:
  - "值得研究的仓库"
description: "开源 Python 工具集：把 Claude Code、Codex、Cursor、Aider 等 10 种 AI 编程助手的本地聊天记录统一提取为标准 JSONL，用于微调、分析与备份。⭐386（7天）。"
---
