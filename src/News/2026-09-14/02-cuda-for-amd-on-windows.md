---
title: "CUDA for AMD on Windows（Windows 上让 AMD GPU 跑 CUDA 应用）"
shortTitle: "CUDA 跑上 AMD 卡"
...
tag:
  - "工程 & Agent"
description: "可复现的 Windows CUDA 兼容方案：ZLUDA + AMD HIP/ROCm 让 CUDA 程序（含 CUDA 版 LibTorch 训练负载）在 RX 9060 XT 上完成完整验证。"
---
